...
#ATTENTION NAME File must begin with test ex. test_runPyTest.py

def runRegistration(link, numberPage):
    with webdriver.Chrome() as browser:
        ...
        assert(welcome_text,'Congratulations! You have successfully registered!','welcome_text texts are different')

        # time.sleep(10)

#name must start with Test
def testFirstPage():
    runRegistration('http://suninjuly.github.io/registration1.html',1)

# name must start with Test
def testSecondPage():
    runRegistration('http://suninjuly.github.io/registration2.html',2)
