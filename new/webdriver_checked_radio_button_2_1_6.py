...
try:
    ...
    radiobut.click()
    radiobut_checked = radiobut.get_attribute('checked')
    print('radiobut_checked',radiobut_checked)
    assert radiobut_checked is not None # radio button is not selected"
    # assert radiobut_checked == 'true','radio button is not selected'
    time.sleep(1)
