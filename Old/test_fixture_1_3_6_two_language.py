...
def browser():
    ...
    # (venv) PS C:\Projects_Python\silenium_auto_test> pytest -s -v test_fixture_1_3_6_two_language.py
    #Call 4 tests for each language 2 -russian +2 english
