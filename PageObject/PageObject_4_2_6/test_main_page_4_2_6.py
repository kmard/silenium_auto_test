from PageObject_4_2_6.main_page import MainPage
import time

#pytest -s -v --tb=line --language=en test_main_page_4_2_6.py
#pytest -s -v --tb=line --language=ru test_main_page_4_2_6.py
