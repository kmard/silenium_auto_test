from PageObject_4_2_4.main_page import MainPage
import time

#pytest -v --tb=line --language=en test_main_page_4_2_4.py
#pytest -v --tb=line --language=ru test_main_page_4_2_4.py
